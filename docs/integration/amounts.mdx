...
:::note
See the [Payment Life Cycle](/docs/integration/payment-lifecycle) section for more information on the items payment life cycle.
:::
...
:::note
See the [Payment Life Cycle](/docs/integration/payment-lifecycle) section for more information on payment statuses.
:::
