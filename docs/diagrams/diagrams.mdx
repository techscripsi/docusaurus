...
import BillingSequenceV2 from '/docs/diagrams/img/billing-sequence-v2.svg'
import BillingSequenceV1 from '/docs/diagrams/img/billing-sequence-v1.svg'
import BillingSequence from '/docs/diagrams/img/billing-sequence.svg'
