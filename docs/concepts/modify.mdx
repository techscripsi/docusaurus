...
The [`modify`](/docs/api/40-modify) request allows you to modify a previously initiated cart. This request is similar to the [`init`](/docs/api/10-init) request in that it allows you to define properties on the cart, tag, and item levels (see the [Carts, Tags, and Items](/docs/concepts/cart) section for more information). Although, there are a number of differences that are covered in this section.
...
Amount settings ​​can be modified on the cart, tag, or item level as with the [`init`](/docs/api/10-init) request (see also the [Cart, Tags, and Items](/docs/concepts/cart) section for more information). An item being modified must be in the `authorized` or `completed status` (see the [Payment Life Cycle](/docs/concepts/lifecycle) section for more information). 
...
:::info
See the [Cancellation and Refund](/docs/concepts/cancel-refund#specific-items-partial) section for more information.
:::
  ...
  <div class="row">
    <div class="col col--6">
      ...
      * `amount` was changed from `1500` to `3000`.
      ...
      :::info
      See the [Amounts](/docs/concepts/amounts) and [Cancellation and Refund](/docs/concepts/cancel-refund#specific-items-partial) sections for more information.
      :::
    </div>
    <div class="col col--6">
      ```js title="Legend"
