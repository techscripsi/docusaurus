...
<div class="container">
  <div class="row">
    <div class="col col--6">
      To capture specific cart items, use the [capture](/docs/api/capture) request. To specify the request scope, apart from the mandatory `cartId` value, provide the criteria for the items to be captured in the `filterBox` object. 
