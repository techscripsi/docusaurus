...
<div class="container">
  <div class="row">
    <div class="col col--6">
      OmniCart allows you to batch apply certain payment settings and timer settings to items in a cart. These settings can be applied to the entire cart or by tag. The tag settings override the cart settings. The settings of a specific item, in turn, override all parent settings, even if this item is marked with a defined tag. Think of it as a nested structure or hierarchical inheritance, cart being the top level.
