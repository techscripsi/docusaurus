...
:::info Please, note
All item identifiers have to be uploaded to OmniCart in the [Merchant Panel](/docs/panel) to be available for purchase as each cart initiation request must contain at least one existing item identifier.
:::
...
<div class="container">
  <div class="row">
    <div class="col col--6">
      ...
      In the example to the right the `items` array contains several item identifiers: `donation`, `milk`, and `premiumAccess`. This code implies these item identifiers were previously [registered in the Merchant Panel](/docs/panel).
    </div>
    <div class="col col--6">
      ```js
        "items": [
