...
:::warning Please, note
Neither the [`cancel`](/docs/api/20-cancel) nor [`refund`](/docs/api/50-refund) request affects item timers. If you need to change timer settings, use the [`modify`](/docs/api/40-modify) request. See the [Item Timers](/docs/concepts/timer) for more information.
:::
