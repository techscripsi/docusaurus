...
<div class="container">
  <div class="row">
    <div class="col col--6">
      To cancel or refund specific cart items, use the <CancelLink /> or <RefundLink /> request respectively. To specify the request scope, apart from the mandatory `cartId` value, provide the criteria for the items to be canceled or refunded in the `filterBox` object. 
