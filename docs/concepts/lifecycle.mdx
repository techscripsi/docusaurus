...
<div class="container">
  <div class="row">
    <div class="col col--6">
      ...
      :::note
      Some requests has on achieved . In these cases, the <StatusLink /> request will return the [`ongoing`](#ongoing) state.
      :::
    </div>
    <div class="col col--6">
...
import SeeCancelRefund from '/docs/_snippets/general/refs/see-cancel-refund.mdx';