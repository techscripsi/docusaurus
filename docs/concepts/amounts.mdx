...
<div class="container">
  <div class="row">
    <div class="col col--6">
      The `paymentSnapshot` object is part of the item object that is returned in the response to the <StatusLink /> request. It contains the values that were defined in the preceding <InitLink /> or <ModifyLink /> request (see the description given [earlier](#totalamounts-itemamounts) on this page).
