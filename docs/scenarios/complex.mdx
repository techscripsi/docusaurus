...
<div class="container">
  <div class="row">
    <div class="col col--6">
      12. <ModifyRequest /> These settings instruct OmniCart to stop the item timer.
      1. The timer is stopped by manual action.
      1. <ModifyResponse />
      1. <SuccessMessage />
    </div>
    <div class="col col--6">
      ### [`modify`](/docs/api/modify) (stop timer)
      <Tabs>
        <TabItem value="request">
          ```js
          {
...
<div class="container">
  <div class="row">
    ...
    <div class="col col--6">
      ### [`init`](/docs/api/init) (set new timer)
      <Tabs>
        <TabItem value="request">
          ```js
          {
...
<div class="container">
  <div class="row">
    ...
    <div class="col col--6">
      ### [`modify`](/docs/api/modify) (reassign tags)
      <Tabs>
        <TabItem value="request">
          ```js
            {
...
<div class="container">
  <div class="row">
    ...
    <div class="col col--6">
      ### [`capture`](/docs/api/capture) by tag
      <Tabs>
        <TabItem value="request">
          ```js
            {
...
<div class="container">
  <div class="row">
    ...
    <div class="col col--6">
      ### [`modify`](/docs/api/modify) (partial refund)
      <Tabs>
        <TabItem value="request">
          ```js
          {
